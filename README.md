...
- The Azure security workspace now ships dedicated review lanes at `/security/access-review`, `/security/identity-review`, `/security/user-review`, `/security/account-health`, and `/security/app-hygiene`. Treat those routes as the canonical operator entrypoints for privileged access, directory identity review, user-account review, account-health review, and application hygiene.
