  ...
  return (
    <div className="space-y-6">
      <AzureSecurityLaneHero
        ...
        description="Track app registration credential expiry, owner coverage, external audience exposure, and publisher trust signals from the cached Microsoft Graph directory dataset."
        accent="amber"
