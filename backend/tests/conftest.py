...
def test_client(mock_cache, freeze_time, monkeypatch):
    ...
    mock_user_admin_providers.list_mailbox_delegates.return_value = {
        ...
        "note": "No Send on behalf, Send As, or Full Access delegates were found for this mailbox.",
        "delegate_count": 0,
        "delegates": [],
    }
    mock_user_admin_providers.list_delegate_mailboxes_for_user.return_value = {
        ...
        "supported_permission_types": ["send_on_behalf", "send_as", "full_access"],
        "permission_counts": {"send_on_behalf": 0, "send_as": 0, "full_access": 0},
        "note": "No delegate mailbox access was found after scanning 0 mailboxes.",
        "mailbox_count": 0,
